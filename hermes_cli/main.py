...
def cmd_dashboard(args):
    ...
    # Unified profile launch routing. The dashboard is a machine management
    # surface; named-profile aliases route to the machine dashboard unless the
    # user explicitly asks for an isolated per-profile server.
    try:
